		...
		<div class="w100 praise lineBottom">
			...
			<div class="praiseImg">
				...
				<div v-for="(v2,k2) in videos" :key="k2">
					...
					<video id="myVideo" :controls="true" :autoplay="false" :src="v2" >
		...
		<div class="w100 praise praise2">
			<div class="praBox">
				...
				<div class="lineBottom alllist" v-for="(items,index) in usercommentList" :key="index">
					...
					<div class="praiseMains">
						<p class="color32 f12">{{items.content}}
						</p>
					</div>
				</div>
				<div class="searchBoxWraper lineBottom" :class="{'searchBoxcss':focustatus}">
					<div class="searchBox">
						<span class="mr15"></span>
						<input type="text" class="search" v-model="setcontent" @focus="searchFocus" @blur="searchblur" placeholder-class="placeholder" :placeholder="placeholder">
