<template>
	<div class="container lineTop" :class="{'iphonex':iPhoneshow}" :style="{height:iphoneheight,minHeight:iphoneheight}">
		<div class="bgc_img">
			...
			<button @click="$router.push({ path:'/pagesSub/userInfo/feedback',query:{pageName:$router.currentRoute.fullPath}})">
				<div></div>
...
export default {
  ...
  onShareAppMessage(options) {
      return {
        title: (this.$store.state.user.userInfo?this.$store.state.user.userInfo.nickName:'') + '给您分享天天逛街的资讯...',
