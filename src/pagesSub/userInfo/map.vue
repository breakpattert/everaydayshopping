     ...
     clickItem: function(latitude,longitude,title,address) {
          ...
          qqmapsdk.reverseGeocoder({
            ...
            success: function (res) {
              ...
              that.$router.push({ path:'/pagesSub/userInfo/editAdress',query: { province: res.result.address_component.province, city: res.result.address_component.city,area: res.result.address_component.district,address: res.result.address_component.street+addressname}})
          ...
          // this.$router.push({ path:'/pagesSub/userInfo/editAdress',query: { address: address}})
     },
  },
