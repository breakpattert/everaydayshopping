  ...
  methods: {
        ...
        if (authInfo) {
          ...
          if (res.mobile) {
            ...
            if (this.$route.query.outLogin == "true") {
              ...
              if (this.$route.query.goPage) {
                this.$router.push({ path: this.$route.query.goPage });
              } else {
                this.$router.go(1);
              }
            }
              ...
              if (this.$route.query.outLogin == "true") {
                this.$router.push({
                  ...
                  query: {
                    index: 1,
                    outLogin: true,
                    goPage: this.$route.query.goPage
                  }
                });
              } else {
                this.$router.push({
    ...
    phoneLogin() {
      if (this.$route.query.goPage) {
        ...
        this.$router.push({ path: "/pagesSub/login/loginPhone" });
      }
    },
    goRegister() {
      if (this.$route.query.goPage) {
        ...
        this.$router.push({ path: "/pagesSub/login/register" });
      }
    },
