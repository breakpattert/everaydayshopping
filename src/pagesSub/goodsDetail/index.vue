  ...
  <div class="container goodsDetail" :class="{'pb34':iPhoneshow}">
    ...
    <van-popup :show="showbottom" custom-class="bottom" @close="togglePopup" position="bottom">
      <div class="big_mask">
        ...
        <div class="addr lineBottom"  @click="$router.push({ path:'/pagesSub/userInfo/myAdress'})">
          <div class="address">
            <span class="mark">
    ...
    <div class="fixedBoxWrap">
      <div class="fixedBox" :class="{'fixedBox_2':iPhoneshow}">
        <div class="todos">
          ...
          <div class="three" @click="$store.state.user.loginStatus?$router.push({ path:'/pagesSub/userInfo/myCar'}):$router.push({ path: '/pagesSub/login/loginIndex' })">
