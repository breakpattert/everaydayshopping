...
const user = {
  ...
  mutations: {
    ...
    SET_IS_RESULT: (state, paylode) => {
      state.resultList = paylode
    },
    ...
    SET_COMMUNITY_CATE_LIST: (state, paylode) => {
      state.communityCateList = paylode
    },
    SET_REFRESH: (state, paylode) => {
      state.refresh = paylode
    },
    SET_UPDATE_NUM: (state, paylode) => {
      state.updateNum = paylode
    }
  },
  actions: {
    async getUserInfo({
