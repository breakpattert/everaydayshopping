...
const api = {
   ...
   * 获取附近优惠
   */
  getNearlySale: (openid, ids, currentClusterId, lat, lng, type, hot, clusterId, jiawei, cateid, nearest, isFollow, page = 1, perPage = 4) => $http.get(`ewei_shopv2_api.php?i=3&r=index.fjyh`, {
    openid,
    ids,
    currentClusterId,
    lat,
   ...
   * 本周逛哪
   */
  getWeekList: (p, c, pindex, psize) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'index.the_week',
    comefrom: 'wxapp',
    timestamp: getTimestamp(),
   ...
   * 首页热门商场--展示推荐的商场
   */
  getReclusterList: (city, page, perPage) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'index.Recluster',
    comefrom: 'wxapp',
    city,
   ...
   * 首页您可能感兴趣的品牌
   */
  getInterestBrandList: (city, openid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'index.random_brands',
    comefrom: 'wxapp',
    city,
    openid
  }),
  /**点击关注可能感兴趣的品牌
   */
  followInterestBrand: (openid, isfollow, brandid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'shop.followBrand',
    comefrom: 'wxapp',
    openid,
   ...
   * 热门商场
   */
  getHotClusterList: (openid, city = '深圳市', lat, lng, page = 1, perPage = 20) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'index.hotCluster',
    comefrom: 'wxapp',
    openid,
   ...
   * 品牌快讯
   */
  getBrandNewsList: (page = 1, perPage = 20) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'index.brandnews',
    comefrom: 'wxapp',
    page,
   ...
   * 商场列表
   */
  marketList: (lat, lng, city, area, pindex, psize, second = 0, recommend = 0, openid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    comefrom: 'wxapp',
    r: 'shop.marketList',
    lat,
   ...
   * 深圳下所有区列表
   */
  getAreaList: (city) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    comefrom: 'wxapp',
    r: 'index.cluster_city_list',
    city
  }),
  /**
   * 商场城市列表
  ...
  upDateSignature: (openid, signature) => $http.post(`ewei_shopv2_api.php?i=3&r=member.info.face`, {
    openid,
    signature
  }),
  /**
   ...
   * 查看我的待付款订单列表
   */
  getOrderList: (openid, status, page = 1) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    comefrom: 'wxapp',
    r: 'order.get_list',
    openid,
   ...
   * 我的关注 -商场
   */
  myclusterfollow: (openid, page, perPage) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'shop.Myclusterfollow',
    page,
    per_page: perPage,
    openid
  }),
   ...
   * 我的关注 -品牌
   */
  mybrandfollow: (openid, page, perPage) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'shop.MyfollowBrand',
    page,
    per_page: perPage,
    openid
  }),
   ...
   * 我的关注 -攻略
   */
  mystrategyfollow: (openid, page, perPage) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'shop.strategy.get_followlist',
    page,
    per_page: perPage,
    openid
  }),
  ...
  /* 新增穿搭接口*/
  strategyList: (merchid, page, pagesize, openid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    comefrom: 'wxapp',
    r: 'shop.strategy.get_list',
    merchid,
    page,
    pagesize,
    openid
  }),
  strategyDetail: (id, merchid, openid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    comefrom: 'wxapp',
    r: 'shop.strategy.detail',
    id,
    merchid,
    openid

  }),
  strategyFollow: (id, openid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    comefrom: 'wxapp',
    r: 'shop.strategy.followorcancel',
    id,
    openid
  }),
  strategyResplist: (strategyid, page, pagesize, openid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    comefrom: 'wxapp',
    r: 'shop.strategy.get_resplist',
    strategyid,
    page,
    pagesize,
    openid
  ...
  /*    攻略点赞或者取消*/
  strategyLike: (strategyid, openid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    comefrom: 'wxapp',
    r: 'shop.strategy.strategy_likeorunlike',
    strategyid,
    openid

  }),
  /* 评论列表对应的点赞*/
  floorReplyLike: (strategyid, commentid, openid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    comefrom: 'wxapp',
    r: 'shop.strategy.comment_likeorunlike',
    strategyid,
    commentid,
    openid
  ...
  /*    回复评论*/
  strategyAdd: (strategyid, openid, content) => $http.post(`ewei_shopv2_api.php?comefrom=wxapp&r=shop.strategy.add_comment&i=3`, {
    strategyid,
    openid,
    content
  }),
  /* 楼层回复评论   */
  floorReply: (strategyid, commontid, from_openid, to_openid, target_id, content) => $http.post(`ewei_shopv2_api.php?comefrom=wxapp&r=shop.strategy.add_reply&i=3`, {
    strategyid,
    commontid,
    from_openid,
    to_openid,
   ...
   * strategy列表
   */
  getStrategyList: (openid, city, area, lat, lng, cateid = '', per_page = 12, page = 1) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    comefrom: 'wxapp',
    r: 'shop.strategy.rand_recommend',
    openid,
    city,
    area,
    lat,
   ...
   * 探探滑动点赞或取消
   */
  strategyisFoke: (strategyid, openid, direction) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    comefrom: 'wxapp',
    r: 'shop.strategy.wipe_strategy',
    strategyid,
    openid,
    direction
  }),
   ...
   * 可够商品
   */
  buyShoping: (strategyid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    comefrom: 'wxapp',
    r: 'shop.strategy.get_productlist',
    strategyid
  }),
  /**
   * strategy
   */
  brandInfoList: (brandid, city, lat, lng, pindex = 1, psize = 4) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    comefrom: 'wxapp',
    r: 'brandDesc',
    brandid,
  ...
  brandNews: (id) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    comefrom: 'wxapp',
    r: 'brandnewsDesc',
    id
   ...
   * 阅读品牌快讯
   */
  readBrandNews: (id) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'index.readBrandNews',
    comefrom: 'wxapp',
    id
  }),
  /**
   * 攻略分类
   */
  strategyCateList: () => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'shop.strategy.get_strategy_cate',
    comefrom: 'wxapp',
   ...
   * 文章详情
   */
  articleDetail: (memberid, openid, articleid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.article.get_article_detail',
    comefrom: 'wxapp',
    memberid,
    openid,
    articleid
   ...
   * 文章评论列表
   */
  articleCommentList: (articleid, openid, page, pagesize) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.article.get_article_comment_list',
    comefrom: 'wxapp',
    openid,
    articleid,
    page,
   ...
   * 文章发布评论
   */
  articleAddComment: (articleid, openid, content) => $http.post(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.article.add_comment',
    comefrom: 'wxapp',
    articleid,
    openid,
    content
  ...
  /* 文章-楼层回复评论   */
  articleFloorReply: (articleid, commentid, from_openid, to_openid, target_id, content) => $http.post(`ewei_shopv2_api.php`, {
    comefrom: 'wxapp',
    r: 'community.article.add_reply',
    i: '3',
    articleid,
    commentid,
    from_openid,
  ...
  /* 文章-评论删除   */
  articleDeleteComment: (commentid, openid) => $http.post(`ewei_shopv2_api.php`, {
    comefrom: 'wxapp',
    r: 'community.article.delete_comment',
    i: '3',
    commentid,
    openid
  }),
  /* 文章-评论点赞   */
  articlePraiseComment: (commentid, openid, articleid) => $http.post(`ewei_shopv2_api.php`, {
    comefrom: 'wxapp',
    r: 'community.article.like_comment_or_cancel',
    i: '3',
    commentid,
    openid,
    articleid
  ...
  /* 文章-回复删除   */
  articleDeleteReply: (replyid, openid) => $http.post(`ewei_shopv2_api.php`, {
    comefrom: 'wxapp',
    r: 'community.article.delete_reply',
    i: '3',
    replyid,
    openid
  }),
  /* 文章-回复点赞   */
  articlePraiseReply: (commentid, openid, replyid) => $http.post(`ewei_shopv2_api.php`, {
    comefrom: 'wxapp',
    r: 'community.article.like_reply_or_cancel',
    i: '3',
    commentid,
    openid,
    replyid
   ...
   * 个人主页的接口
   */
  getPersonalInfo: (memberid, openid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.article.get_member_info',
    comefrom: 'wxapp',
    memberid,
    openid
  }),
  /* 关注接口*/
  personalFllow: (memberid, openid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.article.follow_or_cancel',
    comefrom: 'wxapp',
    memberid,
    openid
  }),
  /*	文章列表*/
  personalList: (memberid, openid, page, pagesize) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.article.get_member_articles',
    comefrom: 'wxapp',
    memberid,
    openid,
    page,
  ...
  personalLike: (memberid, openid, articleid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.article.like_article_or_cancel',
    comefrom: 'wxapp',
    memberid,
    openid,
    articleid
   ...
   * attention list
   */
  attentionList: (openid, page = 1, pagesize = 10) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.article.get_likedlist',
    comefrom: 'wxapp',
    openid,
    page,
    pagesize
  }),
  getBannerImg: () => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.article.get_recommend_banner',
    comefrom: 'wxapp'
  }),
   ...
   * communityCate
   */
  communityCate: (openid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.article.get_app_menu',
    comefrom: 'wxapp',
    openid
  }),
  getRecommend: (page, openid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.article.get_recommend',
    comefrom: 'wxapp',
    page,
    openid
  }),
  getNewsNum: (openid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.article.get_unread_count',
    comefrom: 'wxapp',
    openid
  }),
  getNewsNumList: (openid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.article.get_unread_countlist',
    comefrom: 'wxapp',
    openid
   ...
   * getAskList
   */
  getAskList: (page = 1, per_page = 5) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
  ...
  // 国粉-问答详情
  askDetail: (questionid, openid, page, pagesize) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'question.question_desc',
    comefrom: 'wxapp',
    questionid,
    openid,
    page,
  ...
  // 国粉-问答详情-回答点赞
  askPraise: (openid, answerid, isfavorite) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'question.favoriteanswer',
    comefrom: 'wxapp',
    openid,
    answerid,
    isfavorite
  ...
  // 国粉-问答详情-评论列表
  askCommentList: (answerid, openid, page, pagesize) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'question.comment_list',
    comefrom: 'wxapp',
    openid,
    answerid,
    page,
  ...
  // 国粉-问答详情-发布评论
  askAddComment: (answerid, openid, content) => $http.post(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'question.comment_answer',
    comefrom: 'wxapp',
    answerid,
    openid,
    content
  ...
  /* 国粉-问答详情--楼层回复评论   */
  askFloorReply: (articleid, commentid, from_openid, to_openid, target_id, content) => $http.post(`ewei_shopv2_api.php`, {
    comefrom: 'wxapp',
    r: 'question.add_reply',
    i: '3',
    articleid,
    commentid,
    from_openid,
  ...
  /* 国粉-问答详情--评论删除   */
  askDeleteComment: (commentid, openid) => $http.post(`ewei_shopv2_api.php`, {
    comefrom: 'wxapp',
    r: 'question.del_comment',
    i: '3',
    commentid,
    openid
  }),
  /* 国粉-问答详情--评论点赞   */
  askPraiseComment: (commentid, openid, articleid) => $http.post(`ewei_shopv2_api.php`, {
    comefrom: 'wxapp',
    r: 'question.favoritecomment',
    i: '3',
    commentid,
    openid,
    articleid
  ...
  /* 国粉-问答详情--回复删除   */
  askDeleteReply: (replyid, openid) => $http.post(`ewei_shopv2_api.php`, {
    comefrom: 'wxapp',
    r: 'question.del_reply',
    i: '3',
    replyid,
    openid
  }),
  /* 国粉-问答详情--回复点赞   */
  askPraiseReply: (commentid, openid, replyid) => $http.post(`ewei_shopv2_api.php`, {
    comefrom: 'wxapp',
    r: 'question.favoritereply',
    i: '3',
    commentid,
    openid,
    replyid
  ...
  //   回答的接口*/
  postAnswer: (openid, questionid, content, images) => $http.post(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'question.answer_question',
    comefrom: 'wxapp',
    openid,
    questionid,
    content,
   ...
   * 单个消息列表
   */
  getSingleNews: (type, openid, page, pagesize) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.article.get_message_list',
    comefrom: 'wxapp',
    openid,
    type,
    page,
  ...
  postQuestion: (openid, title, subtitle) => $http.post(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'question.create_question',
    comefrom: 'wxapp',
    openid,
    title,
    subtitle
   ...
   * 消息评论详情
   */
  newsCommentDetail: (msg_id, openid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.article.get_comment_dw',
    comefrom: 'wxapp',
    openid,
    msg_id
  }),
   ...
   * 发布心得
   */
  postFeeling: (title, cover_img, content, tags, openid) => $http.post(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.tag.create_experience',
    comefrom: 'wxapp',
    title,
    cover_img,
    content,
  ...
  //模糊搜索
  searchTag: (keyword, openid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.tag.search_tag',
    comefrom: 'wxapp',
    keyword,
    openid

  }),
  recommentLabList: (isrecommend, openid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.tag.search_tag',
    comefrom: 'wxapp',
    isrecommend,
  ...
  searchLabList: (openid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.tag.search_history',
    comefrom: 'wxapp',
    openid
   ...
   * 社区分类cateGoryList
   */
  cateGoryList: (openid, type, pindex = 1, psize = 10) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.article.articles_type',
    comefrom: 'wxapp',
    openid,
    type,
    pindex,
   ...
   * 添加标签
   */
  creatLabel: (openid, tag) => $http.post(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.tag.add_tag',
    comefrom: 'wxapp',
    openid,
    tag
  }),
   ...
   * 关注数据更新
   */
  antentionUpdate: (openid, start = getTimestamp(), end = getTimestamp()) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.article.newfollowcount',
    comefrom: 'wxapp',
    openid,
    start,
    end
   ...
   * 推荐数据更新
   */
  recommendUpdate: (openid, start = getTimestamp(), end = getTimestamp()) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.article.newrecommendcount',
    comefrom: 'wxapp',
    openid,
    start,
    end
   ...
   * 问答数据更新
   */
  askUpdate: (openid, start = getTimestamp(), end = getTimestamp()) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.article.newquestioncount',
    comefrom: 'wxapp',
    openid,
    start,
    end
   ...
   * 关注数据更新
   */
  recommendTypeUpdate: (openid, type, start = getTimestamp(), end = getTimestamp()) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'community.article.newtypearticles',
    comefrom: 'wxapp',
    openid,
    start,
    end,
   ...
   * 关注数据更新
   */
  userAttentionList: (openid, page = 1, per_page = 10) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'shop.Myfollowmembers',
    comefrom: 'wxapp',
    openid,
    page,
    per_page
   ...
   * 问答点赞或取消
   */
  questionLikeOrCancel: (openid, questionid) => $http.get(`ewei_shopv2_api.php`, {
    i: '3',
    r: 'question.favoritequestion',
    comefrom: 'wxapp',
    openid,
    questionid
  })
