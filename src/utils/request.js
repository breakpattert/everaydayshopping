...
switch (process.env.NODE_ENV) {
  case 'development':
    ...
    //  baseUrlApi = 'https://222.whzxc.cn/app/'
...
fly.interceptors.request.use(async (request) => {
  if (request.body.r !== 'message.messages' &&
    request.body.r !== 'community.article.newfollowcount' &&
    request.body.r !== 'community.article.newrecommendcount' &&
    request.body.r !== 'community.article.newquestioncount' &&
    request.body.r !== 'community.article.newtypearticles' &&
    request.body.r !== 'shop.strategy.get_resplist' &&
    request.body.r !== 'community.article.get_unread_count' &&
    request.body.r !== 'index.upload_formid' && request.body.r !== 'community.article.get_article_comment_list') {
